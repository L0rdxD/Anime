const detailData = () => {
    ...
    const renderAnimeDetails = (array, itemId) => {
        ...
        const widgetList = document.querySelectorAll('.anime__details__widget li')
        const breadcrumb = document.querySelector('.breadcrumb__links span')
        
            if (animeObj) {
                    
                    imageBlock.dataset.setb = animeObj.image
                ...
                // отвечает за загрузку картинок  на уникальных карточках
